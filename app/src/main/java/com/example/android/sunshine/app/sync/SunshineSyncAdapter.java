        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    Intent resultIntent = new Intent(getContext(), SunshineSyncAdapter.class);
                    ...
                    stackBuilder.addParentStack(SunshineSyncAdapter.class);
                    ...
                    if (prefs.getBoolean(context.getString(R.string.pref_enable_notifications_key), true)) {
